 ...
 * @Package com.jr001.view 
 * @Description: TODO(用一句话描述该文件做什么) 
 * @author jiaone@163.com
 * @date 2015-8-9 下午4:24:05 
 * @version V1.0   
 */
 ...
 * @Description: 自定义Listview　下拉刷新,上拉加载更多
 * 
 */
public class CustomListView extends ListView implements OnScrollListener {
	...
	private void initView(Context context) {
		...
		loadingTV = (TextView) header.findViewById(R.id.tv_loading);
	...
	public void onRefreshComplete() {
		String currentTime = DateUtils.getCurDateTime();
	...
	private void refreshHeaderViewByState() {
		...
		case PULL:
			...
			break;
		case RELEASE:
			arrow.setVisibility(View.VISIBLE);//显示
			tip.setVisibility(View.VISIBLE);
			lastUpdate.setVisibility(View.VISIBLE);
			refreshing.setVisibility(View.GONE);//不显
			loadingTV.setVisibility(View.GONE);
			tip.setText(R.string.pull_to_refresh);
